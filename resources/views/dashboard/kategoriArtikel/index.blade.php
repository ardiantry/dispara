                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Kelola Kategori Artikel</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="float-end d-none d-sm-block">
                        <a href="{{ route('kategori-artikel.create') }}" class="btn btn-success">+Tambah Kategori</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive nowrap table-striped"
                        ...
                        <tbody>
                            @forelse($kategoriArtikel as $data)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data['nama_kategori'] }}</td>
                                    <td style="width: 100px" id="tooltip-container0">
                                        <a href="{{ route('kategori-artikel.edit', $data['id']) }}"
                                        ...
                                        <form id="form-delete-{{ $data['id'] }}" method="POST"
                                            action="{{ route('kategori-artikel.destroy', $data['id']) }}">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
