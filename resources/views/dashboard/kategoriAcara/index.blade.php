...
@section('title', 'Kelola Kategori Acara')
@section('breadcrumb')
    <!-- start page title -->
                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Kelola Kategori Acara</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="float-end d-none d-sm-block">
                        <a href="{{ route('kategori-acara.create') }}" class="btn btn-success">+Tambah Kategori</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive nowrap table-striped"
                        ...
                        <tbody>
                            @forelse($kategoriAcara as $data)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data['nama_kategori'] }}</td>
                                    <td style="width: 100px" id="tooltip-container0">
                                        <a href="{{ route('kategori-acara.edit', $data['id']) }}"
                                        ...
                                        <form id="form-delete-{{ $data['id'] }}" method="POST"
                                            action="{{ route('kategori-acara.destroy', $data['id']) }}">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
