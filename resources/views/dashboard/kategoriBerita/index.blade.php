                ...
                <div class="col-sm-6">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Kelola Kategori Berita</li>
                        </ol>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                    <table id="datatable" class="table table-bordered dt-responsive nowrap table-striped"
                        ...
                        <tbody>
                            @forelse($kategoriBerita as $data)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $data['nama_kategori'] }}</td>
                                    <td style="width: 100px" id="tooltip-container0">
                                        <a href="{{ route('kategori-berita.edit', $data['id']) }}"
