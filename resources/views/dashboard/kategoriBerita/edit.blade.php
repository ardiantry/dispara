...
@section('content')
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Edit Kategori Beritamu</h4>
                    <p class="card-title-desc">Edit kategori untuk setiap beritamu agar mempermudah dalam
                        pengelompokkan berita.</p>
                    <form class="custom-validation" action="{{ route('kategori-berita.update', $kategori['id']) }}"
                        method="POST">
                        @csrf
                        @method('put')
                        <div class="mb-3">
                        ...
                        <div class="mb-0">
                            <div>
                                ...
                                <button type="button" class="btn btn-secondary waves-effect"
                                    onclick="window.location.href='{{ route('kategori-berita.index') }}'">
                                    Batal
                                </button>
                            </div>
                        </div>
