        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="custom-validation" action="{{ route('berita.update', $berita['id']) }}" method="POST"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ asset('storage/' . $berita['image']) }}"
                                        alt="{{ $berita->kategori['nama_kategori'] }}" width="350px">
                                </div>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" required
                                value="{{ old('title', $berita['title']) }}" placeholder="Ketikkan judulmu" />
                            @error('title')
                                <span role="alert">
                                    <strong class="text-danger">{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="kategori_id" name="kategori_id"
                                ...
                                @foreach ($kategori_beritas as $item)
                                    @if ($item['nama_kategori'] === $berita->kategori['nama_kategori'])
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="elm1" name="isi" required>{{ old('isi', $berita['isi']) }}</textarea>
                            @error('isi')
                                <span role="alert">
                                    <strong class="text-danger">{{ $message }}</strong>
                                </span>
